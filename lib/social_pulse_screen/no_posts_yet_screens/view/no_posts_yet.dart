...
import 'package:blinx_mobile/social_pulse_screen/connection_error_screen/view/connection_error.dart';
...
import '../../../utils/screens/location_popup.dart';
...
class NoPostsYetScreen extends StatelessWidget {
  NoPostsYetScreen({super.key});
            ...
            Positioned(
              ...
              child: CustomInfoDialog(
                ...
                subtitle: AppConstants
                    .LetsMakeYourFirstBlinxStartWithAPhotoNoteOrPlace,
                buttonText: AppConstants.postTheFirstBlinx,
                onButtonTap: () {
                  Get.to(() => ConnectionErrorScreen());
                },
              ),
            ),
          ],
