...
import 'package:blinx_mobile/screens/task_submission/widget/full_screen_image_widget.dart';
...
class TaskSubmissionScreen extends StatelessWidget {
  ...
  const TaskSubmissionScreen({super.key, required this.applicationId});
  ...
  static Widget _bigInputBox(TaskSubmissionController controller) {
    return Container(
      height: 130,
  ...
  static Widget _buildPhotosBox(
    TaskSubmissionController controller,
    ...
    return Obx(() {
      ...
      final int totalPages = (controller.photos.length / 2).ceil();
      ...
      return Stack(
        children: [
          ...
          if (controller.photos.length < TaskSubmissionController.maxPhotos)
            Positioned(
              left: 70,
              bottom: 8,
              child: GestureDetector(
